...
class JobsDataExporter {
  ...
  generateJobId(job) {
    // Handle both SimplifyJobs (company_name, title, locations[]) and legacy (employer_name, job_title, job_city) formats
  ...
  exportJobs(newJobs) {
    ...
    for (const job of newJobs) {
      ...
      // SimplifyJobs format: company_name, title, locations[], url, date_posted
      const normalizedJob = {
